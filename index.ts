...
const werf_render = execSync(`werf render --env ${environment} --values .helm/values/${environment}.yaml --secret-values .helm/secrets/${environment}.yaml --dev`, { encoding: 'utf-8' });
